  ...
  return (
    <div className="flex md:flex-row flex-col-reverse justify-between mb-[35px] gap-6">
      <div className="lg:flex-1 flex flex-row max-w-[458px] py-2 pl-4 pr-2 h-[52px] bg-[#1c1c24] rounded-[100px]">
        <input
          type="text"
          className="flex w-full font-epilogue font-normal text-[14px] placeholder:text-[#4b5264] bg-transparent text-[#fff] outline-none"
      ...
      <div className="sm:flex hidden flex-row justify-end">
        <CustomButton
          ...
          styles={address ? "bg-[#1bc071]" : "bg-[#8c6dfd]"}
          handleClick={() => {
            if (address) {
      ...
      {/* smalll screen navigation */}

      <div
        className="sm:hidden flex flex-row justify-between
