...
const FundCard = ({
  ...
  return (
    <div
      className="sm:w-[288px] w-ful rounded-[15px] bg-[#1c1c24]
  cursor-pointer"
      onClick={handleClick}
    >
      <img
      ...
      <div className="flex flex-col p-4">
        ...
        <div className="block">
          ...
          lelading-[26px] truncate text-left
          "
          >
            {title}
          </h3>
          <p
            className=" mt-[5px]font-epilogue font-semibold text-[#808191] 
          lelading-[18px] truncate text-left"
          >
            {description}
          </p>
        </div>
        ...
        <div
          className="flex justify-between flex-wrap mt-
        [15px] gap-2"
        >
