...
const CreateCampaign = () => {
  ...
  return (
    <div
      className="bg-[#1c1c24] flex flex-col justify-center
     items-center rounded-[10px] sm:p-10 p-4"
    >
      {isLoading && <Loader />}
      <div className="flex flex-col items-center p-[16px] sm:min-w-[380px] bg-[#3a3a43] rounded-[10px]">
      ...
      >
        ...
        />
        <div
          className="w-full flex justify-start items-center p-4 bg-[#8c6dfd] h-[120px]
        rounded-[10px]"
        >
          <img
            src={money}
          ...
          <h4 className="font-epilogue font-bold text-[25px] text-white ml-[20px]">
            You will receive 100% of the funds raised for your campaign
          </h4>
        </div>
        <div className="flex flex-wrap gap-[40px]">
          <FormField
